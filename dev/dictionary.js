  ...
  dynamicTemplates: [
    ...
    },
    {
      ...
      replacer: function(match, count, unit) {
        ...
        return `${num} ${pluralize(num, units[normalizedUnit])} назад`;
      }
    },
