...
const CONSTANTS = {
  ...
  AUTH_BUTTON_CLASS:
    "shikimori-auth-button" /** CSS class name for the authentication button */,
  AUTH_STATUS_CLASS:
    "shikimori-auth-status" /** CSS class name for the auth status indicator */,
  ANIME_PATH_REGEX:
    /^\/animes\/[a-z]?\d+-([a-z0-9]+-?)+$/ /** Regex to identify anime pages */,
  ANIME_ID_REGEX:
  ...
  OAUTH: {
    ...
    AUTH_URL: "https://shikimori.io/oauth/authorize",
    TOKEN_URL: "https://shikimori.io/oauth/token",
    SCOPES: "user_rates",
  },
};
