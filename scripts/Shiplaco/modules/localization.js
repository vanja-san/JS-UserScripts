...
const Localization = {
  ...
  translations: {
    en: {
      // Output window
      outputWindowTitle: 'Plasheek - Output',
      outputFilterAll: 'All',
      ...
      // Settings dialog
      settingsTitle: 'Plasheek - Settings',
      ...
      authInstructionsStep5: '5. Copy the authorization code from the URL in your browser address bar',
    ...
    ru: {
      // Output window
      outputWindowTitle: 'Shiplaco: Окно логов',
      outputFilterAll: 'Все',
      ...
      // Settings dialog
      settingsTitle: 'Shiplaco: Настройки',
      ...
      authInstructionsStep3: '3. Авторизуйте приложение',
      authInstructionsStep4: '4. Вы будете перенаправлены на страницу с кодом авторизации',
      authInstructionsStep5: '5. Скопируйте код авторизации из адресной строки браузера',
  ...
  detectLanguage() {
    ...
    const storedLang = localStorage.getItem('plasheek_language');
  ...
  setLanguage(lang) {
    if (this.translations[lang]) {
      ...
      localStorage.setItem('plasheek_language', lang);
      return true;
    }
    return false;
  },
