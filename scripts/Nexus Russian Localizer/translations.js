// Словари переводов для NRL.user.js
...
const DICTIONARIES = {
  ...
  main: {
    ...
    "Collections containing this mod": "Коллекции с этим модом",
    "Get hundreds of curated mods the easy way and": "Получайте сотни проверенных модов легко и устанавливайте их ",
    "make it 1-click with premium": "в один клик с премиум-подпиской",
    "The following users have invited you to edit their mods.": "Следующие пользователи позвали тебя править их моды.",
    "You have no pending invitations": "Тебе не пришло ни одного приглашения",
    "Search:": "Поиск:",
    "Previous": "Предыдущая",
    "Last DL": "Скачен",
    "Uploader": "Загрузил",
    ...
    "Details": "Детали",
    "Translations and language": "Переводы и языки",
    "Type tag to add": "Введите тег, чтобы добавить",
    "Popular tags": "Популярные теги",
    "Click to add popular tags.": "Нажмите, чтобы добавить популярные теги.",
    "This is a translation of another mod": "Это перевод для другого мода",
    "Original mod": "Оригинальный мод",
    "Adult tags": "Теги «Для взрослых»",
    "Extra options": "Дополнительные параметры",
    "Team access": "Командный доступ",
    "Invite members": "Пригласить участников",
    "Type a username": "Введи имя пользователя",
    "Search for users...": "Искать по пользователям...",
    "Allow comments": "Разрешить комментарии",
    "Allow discussions": "Разрешить обсуждения",
    "Bug tracker": "Отслеживание ошибок",
    "Public (open)": "Публичный (открытый)",
    "Public (closed)": "Публичный (закрытый)",
    "Private (closed)": "Приватный (закрытый)",
    "No bug tracker": "Без отслеживания ошибок",
    "Community tagging": "Теги сообщества",
    "Download mirrors": "Зеркала для скачивания",
    "Add mirror": "Добавить зеркало",
    "Adding mirror": "Добавление зеркала",
    "Mirror name": "Название зеркала",
    "Mirror URL": "Ссылка зеркала",
    "Cancel": "Отмена",
    "Next (Media)": "Далее (Медиа)",
    "Section complete": "Секция завершена",
    "Mod version": "Версия мода",
    "Author or team name": "Имя автора или команды",
    "Optional": "Необязательно",
    "Allow users to add tags": "Разрешить пользователям добавлять теги",
    "Users can suggest tags for your mod. Tags with 3+ votes are added automatically": "Пользователи могут предлагать теги для твоего мода. Теги с 3+ голосами добавляются автоматически",
    "Display donation button on mod page": "Показывать кнопку пожертвования на странице мода",
    "Display donation message": "Показывать сообщение о пожертвовании",
    "Allows users to donate if you provide a PayPal email address": "Позволяет пользователям жертвовать, если ты укажешь адрес PayPal",
    "Shows a generic donation option when users endorse your file, or download a second time": "Показывает обычную кнопку для доната, когда пользователи рекомендуют твой файл или скачивают его во второй раз",
    "Everyone can view reports, users who downloaded your mod can add reports": "Все могут смотреть жалобы, а добавлять их могут те, кто скачал твой мод",
    "Everyone can view reports, only you (and your team) can add reports": "Все могут смотреть жалобы, а добавлять их можешь только ты (и твоя команда)",
    "Only you (and your team) can view and add reports": "Только ты (и твоя команда) можешь смотреть и добавлять жалобы",
    "Disables the bug tracker entirely": "Полностью отключает отслеживание ошибок.",
    "Forum tab on your mod page for more focused discussions": "Вкладка «Форум» на странице твоего мода — для более конкретных обсуждений",
    "Main Comment tab on your mod page for general conversation": "Основная вкладка комментариев на странице твоего мода — для общения обо всём",
    "You can share edit access with other members to help you manage your mod page.": "Ты можешь дать доступ на редактирование другим участникам, чтобы они помогли тебе управлять страницей мода.",
    "Adult tags ensure your mod is shown to the right audience. Click to add.": "Теги «Для взрослых» нужны, чтобы твой мод показывался нужной аудитории. Нажми, чтобы добавить. ",
    "Describe what your mod does. This is shown on your mod card (see preview).": "Расскажи, что делает твой мод. Это будет показано на карточке мода (смотри превью).",
    "Tell users about your mod in more detail, its main features, how to get started, and any other important info.": "Расскажи пользователям о своём моде подробнее: что он умеет, с чего начать, что важно знать и всё остальное.",
    "Add accurate tags so your mod appears in the right searches and filtered lists.": "Добавь точные теги, чтобы твой мод находился в нужных поисках и отфильтрованных списках.",
    "Select ‘Nexus Mods Turns 25’ to enter your mod into our 25th Anniversary Charity Mod Drive. Donate this mod's DP to Doctors Without Borders, and we'll match your donation!": "Выбери «Nexus Mods Turns 25», чтобы заявить свой мод в нашу благотворительную акцию к 25-летию. Подари очки пожертвований этого мода «Врачам без границ», и мы удвоим твоё пожертвование!",
    ...
    "Manual": "Вручную",
    "Last updated": "Последнее обновление",
    "Original upload": "Оригинал залит",
    "Created by": "Создал",
    "Uploaded by": "Залил на сайт",
    "Virus scan": "Проверка на вирусы",
    "Safe to use": "Безопасен",
    ...
    "Uploaded": "Загружено",
    "Updated": "Обновлённые",
    "Easy install": "Легко установить",
    "Get started with the essential mods.": "Начните с основных модов.",
    "Get starter mods": "Получить стартовые моды.",
    "Buy now": "Купить",
    "Mod on the go with": "Модификации в пути с ",
    "Steam Deck support": "поддержкой Steam Deck",
    "Quick start - skip the steps": "Упрощённая установка (мимо шагов)",
    "Install a curated set of mods to get started fast": "Установите подобранный набор модов для мгновенного начала игры",
    "Collections are a quick way to install a group of mods that \"just work\". ": "Коллекции — это быстрый способ установить набор модов, которые работают «из коробки». ",
    "Prefer to mod manually?": "Предпочитаете модить вручную?",
    "Step 1": "Шаг 1",
    "Step 2": "Шаг 2",
    ...
    "Oops!": "Упс!",
    "The page you are trying to access is not available to guests, but may be available if you sign in.": "Страница, которую вы пытаетесь открыть, недоступна для гостей, но может быть доступна после входа в систему.",
    "Error code:": "Код ошибки: ",
    "Add media": "Добавить медиа",
    "Add images": "Добавить изображения",
    "Link a new video": "Добавить связь с видео",
    "Language": "Язык",
    "Author:": "Автор: ",
    "Animations": "Анимации",
    ...
    "Copyright © 2026 Black Tree Gaming Ltd. All rights reserved.": "Авторские права © 2026 Black Tree Gaming Ltd. Все права защищены.",
    ...
    "Existing user? Sign In": "Зарегистрированы? Войти",
    "Sign Up": "Регистрация",
    "Search...": "Поиск...",
    ...
    "Register a new account": "Зарегистрироваться",
    "Sign In Now": "Войти",
